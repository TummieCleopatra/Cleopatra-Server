...
function onTrigger(player,npc)
    local stock =
    {
        ...
        4930, 107325,    -- Scroll of Katon: San
        4933, 107325,    -- Scroll of Hyoton: San
        4936, 107325,    -- Scroll of Huton: San
        4939, 107325,    -- Scroll of Doton: San
        4942, 107325,    -- Scroll of Raiton: San
        4945, 107325,    -- Scroll of Suiton San
    }
