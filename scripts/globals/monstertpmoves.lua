...
function TrustPhysicalRangedMove(mob,target,skill,basemod,numhits,attmod,accmod,str_wsc,dex_wsc,agi_wsc,vit_wsc,mnd_wsc,tpeffect,mtp100,mtp200,mtp300,offcratiomod)
    local returninfo = {}
    ...
    ratio = utils.clamp(ratio, 0, 3.25)
	-- print("pDIF Corrected")
	-- print(ratio)
