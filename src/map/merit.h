...
enum MERIT_TYPE
{
    ...
    MERIT_ANCIENT_MDB               = MCATEGORY_BLM_2 + 0x02,
    MERIT_ELEMENTAL_ACC             = MCATEGORY_BLM_2 + 0x04,
    MERIT_ELEMENTAL_DEBUFF_DURATION = MCATEGORY_BLM_2 + 0x06,
    MERIT_ELEMENTAL_DEBUFF_EFFECT   = MCATEGORY_BLM_2 + 0x08,
    MERIT_ASPIR_ABSORB_AMOUNT       = MCATEGORY_BLM_2 + 0x0A,
