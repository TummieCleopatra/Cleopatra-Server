...
namespace luautils
{
    ...
    int32 OnCampaignUpdate(CZone* PZone);                                       // hourly conquest update
    ...
    int32 OnTrustWeaponSkill(CBaseEntity* PChar, CBaseEntity* PMob, CMobSkill* PMobSkill, uint16 tp, action_t* action, CBattleEntity* taChar);
