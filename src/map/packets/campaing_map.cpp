...
#include "../../common/showmsg.h"
    ...
    uint8 packet0[] = {
							0x02, 0x01, 0xC4, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x10, 0x05, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
CCampaingPacket::CCampaingPacket(CCharEntity * PChar, uint8 number)
{
    ...
    //ref<uint8>(0x10) = 0x02;  // Total San D'Oria Regions
    //ref<uint8>(0x11) = 0x07;  // Total San D'Oria Regions
    //ref<uint8>(0x12) = 0x01;  // Total San D'Oria Regions
    //ref<uint8>(0x11) = 0x18;
    //ref<uint8>(0x12) = 0x07;
